export default {
  ...
  'settingBotProvider.add': 'Add Bot Provider',
  'settingBotProvider.applicationId': 'Application ID',
  'settingBotProvider.botToken': 'Bot Token',
  'settingBotProvider.createSuccess': 'Bot provider created successfully',
  'settingBotProvider.delete': 'Remove',
  'settingBotProvider.deleteConfirm': 'Are you sure you want to remove this bot provider?',
  'settingBotProvider.description':
    'Connect your agent to external chat platforms like Discord or Slack',
  'settingBotProvider.empty': 'No bot providers configured',
  'settingBotProvider.enabled': 'Enabled',
  'settingBotProvider.platform': 'Platform',
  'settingBotProvider.publicKey': 'Public Key',
  'settingBotProvider.connect': 'Connect',
  'settingBotProvider.connectFailed': 'Failed to connect bot',
  'settingBotProvider.connectSuccess': 'Bot connected successfully',
  'settingBotProvider.title': 'Bot Provider Bindings',
