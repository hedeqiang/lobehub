...
const aihubmixModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'Claude Opus 4.6 Think uses Anthropic API for extended thinking support.',
    ...
    releasedAt: '2026-02-05',
    settings: {
      extendParams: ['disableContextCaching', 'reasoningBudgetToken', 'effort'],
      searchImpl: 'params',
    },
    type: 'chat',
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'Claude Sonnet 4.6 Think uses Anthropic API for extended thinking support.',
  ...
  },
  {
    ...
    contextWindowTokens: 200_000,
    description: 'Claude Sonnet 4.5 Think uses Anthropic API for extended thinking support.',
    ...
    releasedAt: '2025-09-29',
    settings: {
      extendParams: ['disableContextCaching', 'reasoningBudgetToken'],
      searchImpl: 'params',
    },
    type: 'chat',
  },
